...
```bash
git clone https://github.com/Predicate-Labs/sentience-sdk-playground
...
- The distribution name is now `predicate-runtime` for new PyPI installs.
...
* Issues: [https://github.com/Predicate-Labs/sentience-sdk-playground/issues](https://github.com/Predicate-Labs/sentience-sdk-playground/issues?q=sort%3Aupdated-desc%20is%3Aissue)
