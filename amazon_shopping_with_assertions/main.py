...
from predicate.verification import AssertOutcome, exists, url_contains, is_enabled, any_of, all_of
...
async def main() -> None:
    ...
    # NOTE: AsyncPredicateBrowser automatically applies stealth if playwright-stealth is installed
