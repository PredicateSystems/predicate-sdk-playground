...
from predicate.verification import AssertOutcome, exists, url_contains, is_enabled, is_disabled
...
def build_llm_user_prompt(task: str, compact_elements: str) -> str:
    return (
        ...
        "The snapshot shows elements in this format: ID|role|text|importance|is_primary|bg|bg_fallback|clickable|nearby_text|docYq|ord|DG|href|\n"
