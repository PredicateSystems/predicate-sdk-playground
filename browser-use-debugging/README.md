...
This demo shows how to use the **browser-use plugin** built into `sdk-python` (PyPI package: `predicate-runtime`) to attach **deterministic verification** to a browser-use agent.
...
```bash
pip install "predicate-runtime[browser-use]" python-dotenv moviepy pillow
